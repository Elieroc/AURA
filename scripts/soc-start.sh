...
# ambiant du SI et le transforme en whitelists. Cf. ai/soc_agent/training.py.
#
...
# Valeurs par défaut alignées sur ai/soc_agent/config.py : le conteneur doit se
# comporter pareil, que la clé soit présente ou non dans soc-ai.conf.
