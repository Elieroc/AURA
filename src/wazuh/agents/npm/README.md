...
`src/wazuh/agents/pfsense/`), l'hôte NPM est un Linux classique (testé Debian 12 +
...
- `src/wazuh/config/wazuh_cluster/decoders/npm-proxy.xml`
- `src/wazuh/config/wazuh_cluster/rules/100820-npm-proxy-rules.xml`
