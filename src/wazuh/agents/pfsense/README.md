...
`src/wazuh/config/wazuh_cluster/wazuh_manager.conf.example` documente déjà le bloc
...
- `src/wazuh/config/wazuh_cluster/decoders/pfsense-nohostname.xml`
- `src/wazuh/config/wazuh_cluster/rules/100810-100812-*.xml`
